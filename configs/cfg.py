...
C.MODEL.GENETIC.FIXED_PROTOTYPES = True
C.MODEL.GENETIC.POSITION_ENCODING_TYPE = "None"
...
C.DATASET.TRAIN_BATCH_SIZE = 40
C.DATASET.TEST_BATCH_SIZE = 40
C.DATASET.PUSH_BATCH_SIZE = 40
